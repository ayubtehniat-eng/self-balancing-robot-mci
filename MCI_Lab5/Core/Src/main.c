...
void leftMotorForward(int speed) {
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_SET); // IN3
...
void leftMotorBackward(int speed) {
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_10, GPIO_PIN_RESET); // IN3
...
void bothMotorsForward(int speed) {
  leftMotorForward(speed);
  rightMotorForward(speed);
}

void bothMotorsBackward(int speed) {
...
int main(void)
{
  ...
  // HAL_TIM_PWM_Stop(&htim3, TIM_CHANNEL_1); // Stop PWM signal generation
  // Test 1 (Both motors forward at half speed)
  bothMotorsForward(500);
  HAL_Delay(1000);
  bothMotorsBackward(500);
  HAL_Delay(1000);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_10, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA1 PA2 PA10 */
